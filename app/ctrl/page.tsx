...
const FirstChat = dynamic<StageProps>(
  () => import("../components/1_chat.tsx"),
  {
    loading: Loading,
  },
);
const SecondDraw = dynamic<StageProps>(
  () => import("../components/2_draw.tsx"),
  {
    loading: Loading,
  },
);
...
const FifthTitle = dynamic<StageProps>(
  () => import("../components/5_title.tsx"),
  {
    loading: Loading,
  },
);
const SixthChat = dynamic<StageProps>(
  () => import("../components/6_chat.tsx"),
  {
    loading: Loading,
  },
);
...
export default function Play() {
  ...
  if (!isInitialCheckDone) {
    return (
      <div ref={pageRef} style={{ height: "100vh", width: "100vw" }}></div>
    );
  }
